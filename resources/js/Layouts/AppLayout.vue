...
export default {
  name: 'Dashboard',
  components: { Head, Link, JetApplicationMark, JetBanner, JetDropdown, JetDropdownLink, JetNavLink, JetResponsiveNavLink },
  setup() {
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                ...
                                <!-- Team Settings -->
                                <JetResponsiveNavLink :href="route('teams.show', user.current_team)" :active="route().current('teams.show')">
                                    Team Settings
                                </JetResponsiveNavLink>
